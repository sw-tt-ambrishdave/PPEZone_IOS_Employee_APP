...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
		self.color = nil;
        self.labelFont = [UIFont fontWithName:HelveticaNeue_CondensedBold size:kLabelFontSize]; // [UIFont boldSystemFontOfSize:kLabelFontSize]
...
- (void)drawRect:(CGRect)rect {
	...
	CGContextSetFillColorWithColor(context, [_progressColor CGColor]); // [_progressColor CGColor]
	radius = radius - 2;
