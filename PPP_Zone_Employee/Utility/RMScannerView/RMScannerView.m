...
- (void)startCaptureSession {
    ...
    //    if ([APP_DELEGATE.currentViewController isKindOfClass:[loginVC class]]) {
//        videoCaptureDevice = [self frontCamera]; // This code for Front Camera
//    }else{
//        videoCaptureDevice = [AVCaptureDevice defaultDeviceWithMediaType:AVMediaTypeVideo];
//    }
    
    
//    AVCaptureDevice *videoCaptureDevice = [self frontCamera]; // This code for Front Camera
...
//            [device setAutoFocusRangeRestriction:AVCaptureAutoFocusRangeRestrictionFar];
        ...
        if ([self.delegate respondsToSelector:@selector(shouldEndSessionAfterFirstSuccessfulScan)]) {
            ...
            if (shouldEndSession == YES) {
                ...
                if (displayCodeOutline) {
                    ...
                    [UIView animateWithDuration:0.1 animations:^{ // 0.2
                        laserView.alpha = 0.0;
