...
- (CGPoint)centerPointForPosition:(id)point withToast:(UIView *)toast {
    if([point isKindOfClass:[NSString class]])
    {
        ...
        {
            return CGPointMake(self.bounds.size.width/2, (toast.frame.size.height / 2) + CSToastVerticalPadding + 70);
        }
...
//            titleLabel.font = [UIFont boldSystemFontOfSize:24.0];
        ...
        AppFontWithSize(titleLabel, 24.0);
...
//        if (APP_DELEGATE.is_iPad == TRUE)
//        {
//            messageLabel.font = [UIFont boldSystemFontOfSize:24.0];
//        }
//        else
//        {
//            messageLabel.font = [UIFont boldSystemFontOfSize:CSToastFontSize];
//        }
        AppFontWithSize(messageLabel, 24.0);
